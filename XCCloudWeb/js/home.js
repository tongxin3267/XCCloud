                ...
                point:{
                    events: {
                        select: function() {
                            ...
                            switch (text){
                                case "套餐充值":
                                    location.href="test54.html";  //页面跳转
                                    break;
                                case "实币": location.href="test54.html";
                                    break;
                                case '发卡': location.href="test54.html";
                                    break;
                                case '过户币': location.href="test54.html";
                                    break;
                            }
                        }
                    }
                ...
                point:{
                    events: {
                        select: function() {
                            ...
                            console.log(text);
                            switch (text){
                                case 0: location.href="test50.html";  //页面跳转
                                    break;
                                case 1: location.href="test50.html";
                                    break;
                                case 2: location.href="test50.html";
                                    break;
                            }
                        }
                    }
