...
//构造
function layuiXtreeLook(options) {
...
//生产结构
layuiXtreeLook.prototype.dataBind = function (d) {
    var _this = this;
    if (d.length > 0) {
        for (i in d) {
            var xtree_isend = '';
...
//渲染呈现
layuiXtreeLook.prototype.Rendering = function () {
    var _this = this;
...
//子阶段选中改变，父节点更改自身状态
layuiXtreeLook.prototype.ParendCheck = function (ckelem) {
...
//获取全部选中的末级checkbox对象
layuiXtreeLook.prototype.GetChecked = function () {
    var arr = new Array();
    var arrIndex = 0;
