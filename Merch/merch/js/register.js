...
function getNewUl(id) {
    var imgUl="https://mp.4000051530.com/ServicePage/ValidateImg.aspx?";
...
function toNext(obj) {
    if(checkPhone()){
        ...
        $.ajax({
            type:"post",
            url:"https://mp.4000051530.com/xcgamemana/token?action=checkImgCode",
            data:obj,
            dataType:"json",
...
function getMessage() {
    $.ajax({
        type:"post",
        url:"https://mp.4000051530.com/xcgamemana/token?action=sendSMSCode",
...
function registerIn() {
    ...
    if($('.checkbox1').attr('checked')){
        $.ajax({
            type:"post",
            dataType:"json",
            url:"https://mp.4000051530.com/XCGameMana/UserRegister?action=getUserRegister",
...
function do_userGroup() {
    ...
    var url = 'http://mp.4000051530.com/wx/Users?action=GetUserGroup';
...
function do_userGrant() {
    ...
    var parasObj = { "sysId": "0", "versionNo": "0.0.0.1", "workId": workIds };
    var url = 'http://mp.4000051530.com/wx/Users?action=GetUserGrant';
    var parasJson = JSON.stringify(parasObj);
    $.ajax({
        type: "post",
        url: url,
