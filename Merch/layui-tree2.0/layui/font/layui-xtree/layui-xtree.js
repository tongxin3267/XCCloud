...
function layuiXtree(options) {
    ...
    // };
    // obj.send();
    var parasObj = { "merchId": "B4201030001", "token":"1","signkey":"1f626576304bf5d95b72ece2222e42c3" };
    ...
    $.ajax({
        ...
        url:"http://mp.4000051530.com/XCCloud/Dictionary?action=GetNodes",
        success:function (data) {
            data = JSON.parse(data);
            console.log(data.result_data);


            json1= data.result_data[0];
            console.log(json1);
        }
    });
}
