...
var popUpCal = {
    ...
    showCalendar: function() {
        ...
        if (this.timeSeparators.length > 1) {
            ...
            if (this.timeSeparators.length == 4) {
                if (this.selectedHour == 12 || this.selectedHour == 0) timeSelect += '<option value="merch" selected="selected">merch</option>';
                else timeSelect += '<option value="merch">merch</option>';
                for (var a = 1; a < 12; a++) {
