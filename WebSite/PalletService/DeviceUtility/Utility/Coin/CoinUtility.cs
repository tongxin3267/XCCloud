...
namespace DeviceUtility.Utility.Coin
{
    /// <summary>
    /// 售币机业务处理类
    /// </summary>
    public class CoinUtility
    {
        ...
        public CoinUtility()
        {
            try
            {
                ...
                CoinerStateMessage += new CoinerState(CoinerStateNotify);
        ...
        public void SendInit()
        {
            ...
            sendData.Add(0x01);
            sendData.Add(0x06);
            sendData.Add((byte)(CoinUtility.CanWork1 == "1" ? 1 : 0));
            sendData.Add((byte)(CoinUtility.CanWork2 == "1" ? 1 : 0));
