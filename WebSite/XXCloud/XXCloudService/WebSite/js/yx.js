        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //function (){
                    ...
                    $(".panel-body").css({padding:'0'}); //去掉表格内边距
                    //分页
                ...
                var jsonData = [];
                var arrFiled=[];
                for (var i = 0; i < data.result_data.length; i++) {jsonData.push({
                    id: i,
...
$(function () {
    var arrT = ["home.html",
        ...
        "gameCurrency.html","tokenStorage.html", "tokenDestroy.html","tokenSell.html",
        "tokenInstall.html","tokenInventory.html","digitalDestroy.html","digitalInventory.html","digitalSell.html","digitalInstall.html","productRecord.html","test18.html", "test19.html","test20.html",
        "test50.html",
