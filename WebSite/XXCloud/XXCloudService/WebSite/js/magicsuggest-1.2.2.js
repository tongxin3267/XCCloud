    ...
    var MagicSuggest = function(element, options)
    {
                ...
                $.each(_selection, function(index, value){
                    ...
                    if(asText === true) {
                        selectedItemEl = $('<div/>', {
                            ...
                            html: "" + (index === (_selection.length - 1) ? '' : ',')
                        })
                            .data('json', value);
        ...
        var handlers = {
            ...
            _onBlur: function() {
                ...
                $("#bbs").find(".bbsHidden").hide().removeClass("cur");

                var j =$("#ms-sel-ctn-0").find("input[type='hidden']").val();

                var arr= j.substring(1, j.length-1).split(",");
                ...
                else
                {
                    for(var k=0;k<arr.length;k++){
                        ...
                        $("#bbs").find("li").eq(arr[k]).show().addClass("cur");
                    }
                }
            },
